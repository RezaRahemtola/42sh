...
bool check_out_append(command_t *cmd, char **arr, size_t index, environment_t *env);
bool check_out_write(command_t *cmd, char **arr, size_t index, environment_t *env);
bool check_in_file(command_t *cmd, char **arr, size_t index, environment_t *env);
bool check_in_input(command_t *cmd, char **arr, size_t index, environment_t *env);
