...
static char *divide_number(char *str, char *nbr1, char *nbr2, int less)
{
    int i = 0;
...
char *my_infinmod(char const *nbr1, char const *nbr2)
{
    ...
    result = divide_number(str, nb1, nb2, (less1 == 1 ? 1 : 0));
    my_free(3, nb1, nb2, str);
    return (result);
}
